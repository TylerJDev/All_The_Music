			...
			return (
				<div id="main-con" className="container-fluid">
					<div id="main-row" className="row">
						...
						<div id="main-body" className="col-md-12">
							<div id="search-tabs">
							...
							<div id="main-header-results">
								<h2>Total results <small>{resultsTotal[1]}</small></h2>
								<h3><small>{totalResults} pages</small></h3>
								<h3><small>Query: {searchQuery}</small></h3>
							</div>
							<div id="results">
							</div>
							<div id="pagination">
...
/* 			var oldPage = page;
		...
		*/
		...
		ReactDOM.render(<Current />, document.getElementById('current-page'))
